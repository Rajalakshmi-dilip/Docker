...
System.out.println(text);
	...
	public static String toGetAttribute1(WebElement element) {
		String attribute = element.getAttribute("value");
		System.out.println(attribute);
		return attribute;
		}
	...
	public static void screenshot(String filename) throws IOException {
		...
		File dest=new File("C:\\Users\\rajalakshmi.d\\workspace\\Docker\\Screenshot\\"+filename+".png");
...
public static String excelRead(int row,int cell) throws IOException {
		...
		File f=new File("C:\\Users\\rajalakshmi.d\\workspace\\Docker\\testdata\\Amazondata.xlsx");
